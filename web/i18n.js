const APP_TRANSLATIONS = {
  en: {
    ...
    emptyAuditLogs: "No audit events recorded",
  ...
  he: {
    ...
    emptyAuditLogs: "אין אירועי ביקורת",
    operations: "תפעול",
    approval_created: "אישור נוצר",
    approval_approved: "אישור אושר",
    approval_rejected: "אישור נדחה",
    approval_execution: "הרצת אישור",
    scheduled_briefing: "תדריך מתוזמן",
    scheduled_job: "משימת רקע",
    send_briefing: "שליחת תדריך",
